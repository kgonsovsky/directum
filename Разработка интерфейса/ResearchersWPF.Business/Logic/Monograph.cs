...
namespace ResearchersWPF.Business.Logic
{
    public class MonographBl
    {
        ...
        public MonographBl(int monographId)
        {
            Id = monographId;
        }

        public MonographBl(int monographId, string name, string coauthorLastName, string coauthorFirstName,
