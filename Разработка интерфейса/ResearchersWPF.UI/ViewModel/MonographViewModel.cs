...
namespace ResearchersWPF.UI.ViewModel
{
    public class MonographViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        internal MonographViewModel(Monograph monograph)
        {
            Id = monograph.Id;
            Name = monograph.Name;
        ...
        private void Update()
        {
            ...
            if (Mode == Mode.Add)
            {
                monographServiceClient.AddMonograph(Researcher.Id, new Monograph
                {
                    Name = Name,
            ...
            {
                monographServiceClient.UpdateMonograph(new Monograph
                {
                    Name = Name,
                    Id = Id,
                    CoauthorLastName = CoauthorLastName,
