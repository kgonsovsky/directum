...
using ResearchersWPF.Service.Services;
...
namespace ResearchersWPF.UI.ViewModel
{
    public class ResearcherViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        internal ObservableCollection<ArticleViewModel> GetArticles()
        {
            ...
            _articles.Clear();
            var articleServiceClient = new ArticleService();
        ...
        internal ObservableCollection<MonographViewModel> GetMonographs()
        {
            ...
            _monographs.Clear();
            var monographServiceClient = new MonographService();
        ...
        internal ObservableCollection<PresentationViewModel> GetPresentations()
        {
            ...
            var presentationServiceClient = new PresentationService();
        ...
        internal ObservableCollection<ReportViewModel> GetReports()
        {
            ...
            _reports.Clear();
            var reportServiceClient = new ReportService();
        ...
        private void Update()
        {
            var researcherServiceClient = new ResearcherService();
            if (Mode == Mode.Add)
            {
            ...
            {
                researcherServiceClient.UpdateResearcher(new Researcher
                {
                    ResearcherId = Id,
                    LastName = LastName,
                    FirstName = FirstName,
